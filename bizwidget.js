async function CreateWhatsappChatWidget(
  option = {
    brandSetting: {
      ...
      borderRadius: '25',
      brandImg: 'https://sgp1.digitaloceanspaces.com/bizmagnets/dev/logo.png',
      brandImgData: null,
      brandName: 'Bizmagnets',
      brandSubTitle: '',
      ctaText: 'Chat with us',
      welcomeText: 'I have some questions about Bizmagnets, \ncan you help?',
      messageText: 'IÃ¢â‚¬â„¢ve some questions about Bizmagnets, can you help?',
    ...
    document.querySelector('#whatsapp-chat-widget')?.insertAdjacentHTML(
      ...
      `<div class='wa-chat-box'>
                 <img class='wa-chat-box-brand'
                    onError='this.src= "http://sgp1.digitaloceanspaces.com/bizmagnets/dev/logo.png";' 
